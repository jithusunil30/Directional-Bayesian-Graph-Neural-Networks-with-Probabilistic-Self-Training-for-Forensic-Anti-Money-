...
from utils import load_fully_labeled_elliptic_data, calculate_ece
...
def main():
    ...
    print("=" * 85)
    print("   OPTIMIZING THRESHOLDS & GENERATING FINAL ML TRAINING 2 BENCHMARKS   ")
    print("=" * 85)

    data, X_tr, y_tr, X_val, y_val, X_test, y_test, pw = load_fully_labeled_elliptic_data()
    ...
    for name, fpath in models_info:
        ...
        # Find optimal threshold targeting maximum F1 with strong accuracy
        best_th = 0.5
        best_f1 = -1.0
        best_acc = 0.0
    ...
    print("\n" + "=" * 90)
    print("   FINAL ML TRAINING 2 PERFORMANCE BENCHMARK (100% LABELED GRAPH)   ")
    print("=" * 90)
    ...
    plt.title('ML TRAINING 2: Performance Benchmark on 100% Labeled Bitcoin Network', fontsize=14, fontweight='bold', pad=14)
    ...
    plt.suptitle('Confusion Matrices Across 100% Labeled Graph Models (ML TRAINING 2)', fontsize=13, fontweight='bold', y=0.98)
    ...
    plt.title('Combined ROC Curves (100% Labeled Bitcoin Network - ML TRAINING 2)', fontsize=13, fontweight='bold', pad=12)
    ...
    plt.title('Combined Precision-Recall Curves (100% Labeled Bitcoin Network)', fontsize=13, fontweight='bold', pad=12)
    ...
    print("\nML TRAINING 2 Calibration and Figure Generation Completed Successfully!")
