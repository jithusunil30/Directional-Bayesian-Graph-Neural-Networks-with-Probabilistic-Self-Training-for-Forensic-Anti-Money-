...
def main():
    ...
    # Robust path finding for the dataset
    dataset_dir = 'elliptic_bitcoin_dataset'
    if not os.path.exists(dataset_dir) and os.path.exists(os.path.join('..', dataset_dir)):
    ...
    print("Preparing labeled node features spreadsheet...")
